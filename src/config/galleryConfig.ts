...
export const galleryConfig: GalleryConfig = {
	...
	albums: [
		...
		{
			id: "firefly-2026",
			name: "Lưu Anh dễ thương",
			description: "Đom đóm thắp sáng màn đêm dài vô tận, nở rộ trong ngày mai không thể tránh khỏi.",
			location: "Honkai Impact: Đường sắt giữa các vì sao",
			date: "2026-01-01",
			tags: ["Dieu Thu", "HonKai"],
		},
	],
